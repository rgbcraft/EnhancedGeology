...
public class ItemMOXCellx4 extends Item implements IReactorComponent
{
  public static final String name = "MOXCellx4";
  public int damage = 7450;
  
  public ItemMOXCellx4(int id)
  {
    super(id);
    maxStackSize = 1;
    iconIndex = 43;
    setItemName("MOXCellx4");
