...
public class ItemMOXCellx2 extends Item implements IReactorComponent
{
  public static final String name = "MOXCellx2";
  public int damage = 7450;
  
  public ItemMOXCellx2(int id)
  {
    super(id);
    maxStackSize = 1;
    iconIndex = 42;
    setItemName("MOXCellx2");
