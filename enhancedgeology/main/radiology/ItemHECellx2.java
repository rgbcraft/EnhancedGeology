...
public class ItemHECellx2 extends Item implements IReactorComponent
{
  public static final String name = "HECellx2";
  public int damage = 7450;
  
  public ItemHECellx2(int id)
  {
    super(id);
    maxStackSize = 1;
    iconIndex = 36;
    setItemName("HECellx2");
