...
public class ItemMGECellx4 extends Item implements IReactorComponent
{
  public static final String name = "MGECellx4";
  public int damage = 7450;
  
  public ItemMGECellx4(int id)
  {
    super(id);
    maxStackSize = 1;
    iconIndex = 40;
    setItemName("MGECellx4");
