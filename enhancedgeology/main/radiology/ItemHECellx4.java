...
public class ItemHECellx4 extends Item implements IReactorComponent
{
  public static final String name = "HECellx4";
  public int damage = 7450;
  
  public ItemHECellx4(int id)
  {
    super(id);
    maxStackSize = 1;
    iconIndex = 37;
    setItemName("HECellx4");
