...
public class ItemLECellx4 extends Item implements IReactorComponent
{
  public static final String name = "LECellx4";
  public int damage = 7450;
  
  public ItemLECellx4(int id)
  {
    super(id);
    maxStackSize = 1;
    iconIndex = 34;
    setItemName("LECellx4");
