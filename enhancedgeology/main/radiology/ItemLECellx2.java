...
public class ItemLECellx2 extends Item implements IReactorComponent
{
  public static final String name = "LECellx2";
  public int damage = 7450;
  
  public ItemLECellx2(int id)
  {
    super(id);
    maxStackSize = 1;
    iconIndex = 33;
    setItemName("LECellx2");
